...
;;
;; Thomas Fr嘖sman for his work on solarized-emacs.
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       (terminal-monokai-bg               "#000") ; (terminal-monokai-bg               "#1B1E1C")
       ...
       (terminal-s-mode-line-fg "#FFF")
       (terminal-s-mode-line-bg "#0087AF")
       (terminal-s-mode-line-buffer-id-fg "#FFF")
